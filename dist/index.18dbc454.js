...
/* FORMULAIRE PAGE 1 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const mobilityContainer = document.querySelector(".big-booking-person .l-space-column-mini");
    ...
    function renderMobilitySections(adultCount, childCount) {
        ...
        for(let i = 1; i <= adultCount; i++)mobilityContainer.appendChild(createMobilityBlock("Adulte", i));
        for(let i = 1; i <= childCount; i++)mobilityContainer.appendChild(createMobilityBlock("Enfant", i));
    }
    function createMobilityBlock(type, index) {
      ...
      <div class="l-space-column-mini">
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="ag-${type}-${index}">Abonnement g\xe9n\xe9ral (AG)</label>
        </div>
        <div class="form-check">
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="none-${type}-${index}">Pas d\u{2019}abonnement</label>
        </div>
      </div>
    `;
        return section;
...
},{"../shared/create-shadow.mjs":"bWkQq","../shared/effect-init.mjs":"88TTi","../shared/effect-target.mjs":"3jkAD","../shared/effect-virtual-transition-end.mjs":"dzFvU","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j2YDk","1SICI"], "1SICI", "parcelRequire0300")
